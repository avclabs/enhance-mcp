...
[![npm version](https://badge.fury.io/js/@avclabs.ai%2Fenhance-mcp.svg)](https://www.npmjs.com/package/@avclabs.ai/enhance-mcp)
...
```
Install the npm package @avclabs.ai/enhance-mcp as an MCP server. My API Key is: sk-xxxxxxxx.
```
...
| `HTTP_API_BASE_URL` | No | `https://mcp.avc.ai` | Service endpoint |
